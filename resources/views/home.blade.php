...
<div class="container mt-4">
    ...
    <!-- CAROUSEL -->
    <div id="homeCarousel" class="carousel slide carousel-fade mb-5" data-bs-ride="carousel" data-bs-interval="2000" style="max-width: 900px; margin:auto;">
    ...
    <div class="text-center">
        ...
        <a href="{{ route('products.index') }}" class="btn btn-outline-primary btn-lg mt-3">
            Voir les produits
        </a>
    </div>
